...
#include "../ManagerBase/addrowdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddRowDialog_t, stringdata) + ofs \
...
void AddRowDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddRowDialog *_t = static_cast<AddRowDialog *>(_o);
        switch (_id) {
...
const QMetaObject AddRowDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddRowDialog.data,
      qt_meta_data_AddRowDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddRowDialog.stringdata))
        return static_cast<void*>(const_cast< AddRowDialog*>(this));
